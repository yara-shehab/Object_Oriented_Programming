             ...
             btnsearch.addActionListener( new ActionListener() {
                ...
                public void actionPerformed(ActionEvent ae) {
                     ...
                     for(int i=0;i<Inbody.listofinbodys.size();i++)
                     {
                       ...
                       if(Inbody.listofinbodys.get(i).getID1(i).equalsIgnoreCase(txtID.getText()))
                         {
                             area.setText("ID :"+txtID.getText()+"\n"+"Height :"+Inbody.listofinbodys.get(i).getheight1(i)
                             +"Age :"+"\n"+Inbody.listofinbodys.get(i).getage1(i)+"\n"+"Gender :"+Inbody.listofinbodys.get(i).getgender1(i)
                             +"\n"+"Test Date :"+Inbody.listofinbodys.get(i).gettestdate1(i)+"\n"+"Time :"+Inbody.listofinbodys.get(i).gettime1(i)
                             +"\n"+"Body Fat :"+Inbody.listofinbodys.get(i).getbodyfat1(i)+ "\n"+"Weight :"+ Inbody.listofinbodys.get(i).getweight1(i)+ "\n"+"BMI :"+ Inbody.listofinbodys.get(i).getBMI1(i)+ "\n"+ "PBF :"+Inbody.listofinbodys.get(i).getPBF1(i));
                             z++;
                         }
