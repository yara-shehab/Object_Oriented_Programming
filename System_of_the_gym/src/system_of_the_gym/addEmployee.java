...
public class addEmployee extends JFrame {
    ...
    AddEmployeeController ca = new AddEmployeeController();
    ...
    public addEmployee() {
        ...
        saved.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                String i, n, a, d, m, y, h, w, cm, ty, tn,l;
                ...
                y = txtyear.getText();
                h = txtsalary.getText();
                w = comdayreg.getSelectedItem().toString();
                cm = commonthreg.getSelectedItem().toString();
                ty = txtyearreg.getText();
                tn = txtposition.getText();

               l= ca.AddEmployeeController1(i, n, a, d, m, y, h, w, cm, ty, tn);
                txtid.setText(l);
                txtname.setText("");
                txtadress.setText("");
                txtsalary.setText("");
