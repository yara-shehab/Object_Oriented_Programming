...
public class ListOfInbody extends JFrame{
    public ListOfInbody()
    {
        ...
        {
        areaid.setText(Inbody.listofinbodys.get(i).getID());
        }
        for(int i=0;i<Inbody.listofinbodys.size();i++)
        {
        areaheight.setText(Inbody.listofinbodys.get(i).getheight());
        }
        for(int i=0;i<Inbody.listofinbodys.size();i++)
        {
        areaage.setText(Inbody.listofinbodys.get(i).getage());
        }
        for(int i=0;i<Inbody.listofinbodys.size();i++)
        {
        areagender.setText(Inbody.listofinbodys.get(i).getgender());
        }
        for(int i=0;i<Inbody.listofinbodys.size();i++)
        {
        areatestdate.setText(Inbody.listofinbodys.get(i).gettestdate());
        }
        for(int i=0;i<Inbody.listofinbodys.size();i++)
        {
        areatime.setText(Inbody.listofinbodys.get(i).gettime());
        }
        for(int i=0;i<Inbody.listofinbodys.size();i++)
        {
        areabodyfat.setText(Inbody.listofinbodys.get(i).getbodyfat());
        }
        for(int i=0;i<Inbody.listofinbodys.size();i++)
        {
        areaweight.setText(Inbody.listofinbodys.get(i).getweight());
        }
        for(int i=0;i<Inbody.listofinbodys.size();i++)
        {
        areaBMI.setText(Inbody.listofinbodys.get(i).getBMI());
        }
        for(int i=0;i<Inbody.listofinbodys.size();i++)
        {
        areaPBF.setText(Inbody.listofinbodys.get(i).getPBF());
        }
